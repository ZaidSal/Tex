...
% TODO: in person citations:
%   IT Department: (high level) topology, number of devices (vague), if they use cisco or other, power consumption,
%   Engr Department: number of buildings, floor plans
%   General Services: power draw, what percentage of power is solar, finance

% TODO: rewrite sections if they sound weird 
...
% TODO: rewrite this section; we need to get exact details about what system they have
% After YU's Student Information System update in December 2023, the system responsiveness has improved, we couldn't get information from the YU IT department about the current network infrastructure since such information is confidential. But the overall behavior of the network suggests that they are using cheap products that is not suitable for the site.
...
% TODO: test internet load balancing and cite; do on monday
